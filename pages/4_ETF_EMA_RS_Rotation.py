"""
Interactive portal for the EMA + relative-strength "N-of-3 vote" ETF
rotation strategy. See ema_rs_rotation_engine.py for the full mechanics.

Lets you customise the equity leg rotated against GOLDBEES (Nifty 50,
Midcap 150, Smallcap 250, or Nifty 500), the two EMA periods, the
relative-strength lookback, and how many of the three criteria must
agree to hold the equity ETF instead of GOLDBEES, and see the resulting
strategy performance update live.
"""
import pandas as pd
...
from streamlit_cache import cached_load_ema_rs_data

st.set_page_config(page_title="ETF EMA+RS Rotation", layout="wide")

st.title("ETF EMA + Relative-Strength Rotation")
st.caption(
